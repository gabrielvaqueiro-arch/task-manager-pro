...
function pintar() {
    ...
    // Borra todo el contenido del listado de tareas
lista.innerHTML = "";


// Coge lo que el usuario ha escrito en el buscador
let texto = buscador.value.toLowerCase();


// PANEL RESUMEN

// Muestra el número total de tareas (longitud del array)
totalSpan.textContent = tareas.length;


// Cuenta cuántas tareas están en estado "Pendiente"
// filter crea un nuevo array solo con esas tareas
// .length cuenta cuántas hay
let pendientes = tareas.filter(t => t.estado === "Pendiente").length;


// Muestra el número de tareas pendientes en el HTML
